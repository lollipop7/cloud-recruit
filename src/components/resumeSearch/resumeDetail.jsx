                        ...
                        <div className="details-item-intention">
                            ...
                            <div className="intention">
                                <div className="intention-item">
                                    ...
                                    {!Array.isArray(item.expectPositions) ? <span className="positionIntention" >{item.expectPositions}</span>:
                                        <Dropdown 
                                ...
                                <div className="intention-item">
                                    <span>更新时间：</span>
                                    <span>{item.esumeLastUpdate?moment(item.esumeLastUpdate).format("YYYY-MM-DD"):"暂无"}</span>
                                </div>
                            </div>  
                        </div>
                        <div className="details-item-main">
                            <div className="main-left">
                                <h3>{item.name}{item.sex=="男"?"先生":item.sex=="女"?"女士":""} | 
                                    {item.age}岁 | {item.workedYears}年 | {item.lastCompany} | 
                            ...
                            <div className="main-right">
                                ...
                                { location.pathname!=="/searchResume/downloadResume" &&
                                    <Button 
                                        type="primary" 
                                        ghost 
                                        className="detailBtn"
                                    ...
                                    >
                                        {location.pathname=="/searchResume/collectResume" ?"取消收藏":"收藏"}
                                    </Button>
                                }
                                <div style={{width:"100%",height:10}}></div>
                                {path ==="collectResume" &&
